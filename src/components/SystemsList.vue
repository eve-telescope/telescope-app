...
<template>
    <div v-if="systems.length" class="space-y-1">
        ...
        >
            <span class="text-eve-text-1 truncate max-w-24">{{
                sys.system_name
            }}</span>
            ...
            <!-- Hover links -->
            <div
                class="absolute right-0 opacity-0 group-hover:opacity-100 transition-opacity flex gap-0.5 bg-eve-bg-2 pl-2"
            >
                <button
