  ...
  <div>
    <div class="space-y-0.5 text-xs">
      <div class="flex justify-between gap-4">
        ...
        <span class="font-mono text-eve-text-1">{{ stats.solo_kills.toLocaleString() }}</span>
      </div>
      <div class="flex justify-between gap-4">
        <span class="text-eve-text-2">Danger</span>
        <span class="font-mono text-eve-text-1">{{ stats.danger_ratio.toFixed(0) }}%</span>
      </div>
      <div class="flex justify-between gap-4">
        <span class="text-eve-text-2">Gang</span>
        <span class="font-mono text-eve-text-1">{{ stats.gang_ratio.toFixed(0) }}%</span>
      </div>
    </div>
    <button
