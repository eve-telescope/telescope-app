    ...
    <div class="space-y-2">
        ...
        <div class="space-y-1">
            ...
            >
                ...
                <span class="font-mono text-eve-threat-extreme font-semibold">{{
            ...
            >
                ...
                <span class="font-mono text-eve-threat-high font-semibold">{{
                    threatCounts.high
                }}</span>
            </div>
            ...
            >
                ...
                <span class="font-mono text-eve-threat-moderate">{{
            ...
            <div
                class="flex items-center justify-between text-xs"
                v-if="threatCounts.minimal > 0 || threatCounts.unknown > 0"
            >
                <span class="flex items-center gap-1.5">
                    <span
                ...
                <span class="font-mono text-eve-text-3">{{
                    threatCounts.minimal + threatCounts.unknown
                }}</span>
            </div>
        </div>
        ...
        >
            ...
            <span
                >{{ dangerousCount }} dangerous pilot{{
                    dangerousCount > 1 ? 's' : ''
                }}
                detected</span
            >
