...
<template>
    <div class="flex flex-col gap-0.5">
        ...
        <div class="flex items-center mb-0.5">
            <span class="w-7"></span>
            <div
                class="flex-1 flex justify-between text-[8px] text-eve-text-3 px-0.5"
            >
                <span>00</span>
                <span>06</span>
                <span>12</span>
        ...
        <div class="relative">
            ...
            <div
                ...
                :style="{
                    left: `calc(28px + (100% - 28px) * ${currentHourPercent / 100})`,
                }"
            ></div>
            ...
            >
                <span
                    ...
                    :class="
                        dayIndex === eveTime.day
                            ? 'text-eve-cyan font-semibold'
                            : 'text-eve-text-3'
                    "
                    >{{ DAYS[dayIndex] }}</span
                >
        ...
        <div class="text-right mt-1">
            <span class="font-mono text-eve-cyan text-[9px]">
                {{ formatHour(eveTime.hour) }}:{{ formatHour(eveTime.minutes) }}
                EVE
            </span>
        </div>
    </div>
