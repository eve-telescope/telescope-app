...
<template>
  <div class="flex flex-col min-h-0">
    <h4 class="text-[10px] font-semibold tracking-wider text-eve-text-3 uppercase mb-2 flex items-center gap-2 shrink-0">
      {{ title }}
      <span class="font-mono text-[9px] text-eve-text-3 bg-eve-bg-3 px-1.5 py-0.5 rounded">{{ items.length }}</span>
    </h4>
